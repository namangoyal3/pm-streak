...
export default function InterviewSprintPage() {
  return (
    <div className="min-h-screen bg-[var(--bg-primary)] text-white flex flex-col items-center justify-center px-6 pb-24">
      <Mic size={48} className="text-[var(--green-primary)] mb-4" />
      <h1 className="text-2xl font-black text-center mb-2">Interview Sprint</h1>
      <p className="text-sm text-[var(--text-secondary)] text-center max-w-md mb-6">
        Product sense drills, prioritization cases, estimation prompts, and AI
        answer feedback — included in PM Streak Pro.
      </p>
      <Link
        href="/pricing"
