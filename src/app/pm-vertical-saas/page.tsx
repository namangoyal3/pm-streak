...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: `${SITE_URL}/api/og?title=PM+Vertical+SaaS+2026++PM+Streak`, width: 1200, height: 630 }],
    type: "article",
  },
  twitter: {
    ...
    title: "PM Vertical SaaS 2026 — PM Streak",
    description: "How PMs build vertical SaaS.",
    images: [`${SITE_URL}/api/og?title=PM+Vertical+SaaS+2026++PM+Streak`],
    site: "@pmstreak",
  },
};
...
export default function PmVerticalSaasPage() {
  const dates = pageDates("/pm-vertical-saas");
  return (
    <>
      ...
      <JsonLd data={articleSchema({
        headline: "PM Vertical SaaS (2026 Edition)",
        description:
          "How PMs build vertical SaaS. Deep domain workflows, payments embedding, and why going narrow and deep beats horizontal at the margin.",
        image: `${SITE_URL}/api/og?title=PM+Vertical+SaaS+2026++PM+Streak`,
      ...
      <main className="min-h-screen bg-[#0e1113] text-white">
        ...
        <RelatedPages slug="pm-vertical-saas" />
