...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: `${SITE_URL}/api/og?title=PM+AI+ROI+Measurement+2026++PM+Streak`, width: 1200, height: 630 }],
    type: "article",
  },
  twitter: {
    ...
    title: "PM AI ROI Measurement 2026 — PM Streak",
    description: "Proving AI pays off.",
    images: [`${SITE_URL}/api/og?title=PM+AI+ROI+Measurement+2026++PM+Streak`],
    site: "@pmstreak",
  },
};
