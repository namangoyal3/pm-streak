            ...
            <div className="bg-white/5 rounded-xl p-4 mb-6">
              ...
              <div className="space-y-2 text-sm">
                <div className="flex justify-between">
                  ...
                  <span><span className="line-through text-white/30">₹1,663</span> <span className="text-green-400 font-black">₹499</span></span>
                </div>
                <div className="flex justify-between">
                  <span className="text-white/70">Quarterly</span>
                  <span><span className="line-through text-white/30">₹2,997</span> <span className="text-green-400 font-black">₹899</span></span>
                </div>
                <div className="flex justify-between">
                  <span className="text-white/70">Yearly</span>
                  <span><span className="line-through text-white/30">₹8,997</span> <span className="text-green-400 font-black">₹2,699</span></span>
                </div>
              </div>
            </div>
