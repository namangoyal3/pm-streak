          ...
          <div className="bg-[var(--bg-card)] rounded-2xl p-5 border border-[var(--border-color)] space-y-4">
            <div>
              ...
              <p className="text-xs text-[var(--text-secondary)] mt-1">
                Use this panel when the summary gave you the gist but you want more context, adjacent lessons, or a richer follow-up on the same topic.
              </p>
            </div>
            ...
            {aiGenerated && (
              <p className="text-[10px] text-[var(--text-secondary)]">
                This is a bonus custom lesson. It can keep your streak alive, but
                your category unlocks still come from the main curriculum.
              </p>
            )}
          </div>
        )}
        ...
        >
          <div className="mb-6">
            ...
            <p className="text-[var(--text-secondary)] text-sm">
              {score >= 80
                ? "Crushed it — keep this streak alive."
                : score >= 50
          ...
          {streakGoal > 0 && (
            <div className="bg-[var(--bg-card)] rounded-2xl p-4 mb-4 text-left">
              ...
              {goalReached && (
                <p className="text-[10px] text-[var(--gold-primary)] font-bold mt-1 text-center">
                  🏆 Goal reached!
                </p>
              )}
            </div>
          ...
          <div className="grid grid-cols-2 gap-3 mb-6">
            ...
            <div className="bg-[var(--bg-card)] rounded-2xl p-4">
              <div className="text-3xl font-bold text-[var(--green-primary)]">
                {score}%
              </div>
              <div className="text-xs text-[var(--text-secondary)] mt-1">
          ...
          {confirmed && (
            ...
            >
              <div className="font-bold mb-1 flex items-center gap-2">
                {isCorrect ? (
                  <>
                    <Check size={16} className="text-[var(--green-primary)]" />{" "}
                    Correct!
                  </>
                ) : (
                  <>
